...
const Fitinfo3 =(props)=>{
    ...
    return(
        ...
        < div className="element-container">
           ...
           <h2 className="main-heading-style">{item.B22heading3}</h2>
          
           <img src={item.A21img} className="img-ele"></img>
           
           
           <p className="para-style">{item.C23para}</p>
           <p className="para-style">{item.D24para2}</p>
