...
const TourElement2 =(props)=>{
    ...
    return(
        ...
        < div className="element-container">
           ...
           <h2 className="main-heading-style">{item.B1heading2}</h2>
          
           <img src={item.B2img} className="img-ele"></img>
           
           
           <p className="para-style">{item.B3para}</p>
