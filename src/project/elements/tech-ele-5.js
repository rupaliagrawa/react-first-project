...
const TechArticle5 =(props)=>{
    ...
    return(
        ...
        < div className="element-container">
           ...
           <h2 className="main-heading-style">{item.E1heading}</h2>
          
           <img src={item.E2img} className="img-ele"></img>
           
           
           <p className="para-style">{item.E3para}</p>
           <p className="para-style">{item.E4para1}</p>
           <p className="para-style">{item.E5para2}</p>
